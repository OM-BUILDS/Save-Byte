...
import styles from "./AwcTransactionHistory.module.css";
import { useHttpClient } from "../../hooks/http-hook";
import { BASE_API_URL } from "../../api/api";
import { AuthContext } from "../../context/auth-context";
import { showErrorToast, showSuccessToast } from "../../utils/toast";
import AwcTrackFood from "./AwcTrackFood"; // Import TrackFood Component

export default function AwcTransactionHistory() {
    ...
    const fetchTransactions = async () => {
      try {
        const response = await sendRequest(
          `${BASE_API_URL}/get-all-awc-transactions/${auth.userId}`,
          "GET",
          null,
          {
  ...
  return (
    <div className={styles.container}>
      ...
      {selectedTransaction && (
          ...
          <AwcTrackFood transactionId={activeTransaction}
            donorCoords={{
