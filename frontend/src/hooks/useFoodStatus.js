...
import styles from "./FoodStatus.module.css";
import DarkButton from "../../../components/button-component/DarkButton";
import LightButton from "../../../components/button-component/LightButton";
...
export default function FoodStatus() {
  ...
  const handleSortChange = (e) => {
    ...
    switch (selectedSortOption) {
      case "wasteFoodType":
        sortedData.sort((a, b) => a.wasteFoodType.localeCompare(b.wasteFoodType));
        break;
  ...
  return (
    <div className={styles.container}>
      ...
      {loading && <p className={styles.loading}>⏳ Loading donated food data...</p>}
              ...
              {donatedFoods.map((donation, index) => {
                ...
                return (
                  <tr key={donation._id}>
                    ...
                    <td>{donation.expiredIn?.text || "Expired"}</td>
                    <td>
                      <DarkButton
                        buttonText="Delete"
